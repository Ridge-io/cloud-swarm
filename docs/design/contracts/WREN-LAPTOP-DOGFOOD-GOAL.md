...
An invite to **CommonSwarm Build** was created for `tom@chartingalpha.com`. If it has expired, say so
and the lead will mint a fresh one.

1. Signed in on the laptop as `tom@chartingalpha.com`, open the invite link the operator has.
2. Accept.
